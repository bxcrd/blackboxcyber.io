			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - Blackbox Cyber | Your Cyber Security Solutions Partner &#8211; Australia</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - Blackbox Cyber | Your Cyber Security Solutions Partner &#8211; Australia</title>
					</xsl:otherwise>
				</xsl:choose>
